        ...
        <div className="our_solution_category">
          <div className="solution_cards_box">
            <div className="solution_card">
              ...
              <div className="solu_description">
                <p>App development</p>
                <p>
                Embark on a transformative journey into the world of app development with our comprehensive course, equipping you with essential skills in coding, design, and deployment. 
                
                </p>
                {/* <button type="button" className="read_more_btn">
                <Link to='/view' >View Courses</Link>
                </button> */}
              </div>
            </div>
            <div className="solution_card">
              ...
              <div className="solu_description">
                <p>Networking</p>
                <p>
                Explore the fundamentals of computer networks in this comprehensive course, covering key concepts like protocols, routing, 
                and data transmission to equip you with the knowledge in the digital world. 
                </p>
                {/* <button type="button" className="read_more_btn">
                  View Enquiries
                </button> */}
          ...
          <div className="solution_cards_box sol_card_top_3">
            <div className="solution_card">
              ...
              <p>Deep Learning</p>
                <p>
                Dive into the transformative world of deep learning with our comprehensive course,
                 designed to unravel the complexities of neural networks, algorithms, and advanced techniques.
                </p>
                {/* <button type="button" className="read_more_btn"> */}
                {/* <Link to='/add' >Add Enquiries</Link> */}
                {/* </button> */}
